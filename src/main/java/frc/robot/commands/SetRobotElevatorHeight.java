              ...
              case Rocket:
                switch (RobotState.getPositionState()) {
                  case High:
                    ...
                    //setpoint = new ElevatorArmSetpoint(Robot.jl.getHeight("FrontBallRocketHigh"), Robot.jl.getAngle("FrontBallRocketHigh"));
                    break;
                  case Medium:
                    //setpoint = new ElevatorArmSetpoint(Robot.jl.getHeight("FrontBallRocketMiddle"), Robot.jl.getAngle("FrontBallRocketMiddle"));
